...
namespace DS3231
{
	...
	inline void assign_bcd_bits(uint8_t* buffer, uint8_t index, uint8_t value, uint8_t unitsOffset, uint8_t tensOffset, uint8_t unitsBits, uint8_t tensBits);
	inline void assign_bits(uint8_t* buffer, uint8_t index, uint8_t offset, uint8_t count, uint8_t value);
	inline uint8_t extract_bcd_bits(uint8_t* buffer, uint8_t index, uint8_t unitsOffset, uint8_t tensOffset, uint8_t unitsBits, uint8_t tensBits);
	inline uint8_t extract_bits(uint8_t* buffer, uint8_t index, uint8_t offset, uint8_t count);
